...
const UNIDAD_3_VISIBLE = false;  // Unidad III: Legislación de la PI
const UNIDAD_4_VISIBLE = false;  // Unidad IV: Derecho de Autor y Conexos
const UNIDAD_5_VISIBLE = false;  // Unidad V: PI y su Aplicación
